...
#define BATTLE_TERRAIN_GRASS        BATTLE_ENVIRONMENT_GRASS
#define BATTLE_TERRAIN_LONG_GRASS   BATTLE_ENVIRONMENT_LONG_GRASS
#define BATTLE_TERRAIN_SAND         BATTLE_ENVIRONMENT_SAND
#define BATTLE_TERRAIN_UNDERWATER   BATTLE_ENVIRONMENT_UNDERWATER
#define BATTLE_TERRAIN_WATER        BATTLE_ENVIRONMENT_WATER
#define BATTLE_TERRAIN_POND         BATTLE_ENVIRONMENT_POND
#define BATTLE_TERRAIN_MOUNTAIN     BATTLE_ENVIRONMENT_MOUNTAIN
#define BATTLE_TERRAIN_CAVE         BATTLE_ENVIRONMENT_CAVE
#define BATTLE_TERRAIN_BUILDING     BATTLE_ENVIRONMENT_BUILDING
#define BATTLE_TERRAIN_PLAIN        BATTLE_ENVIRONMENT_PLAIN
#define BATTLE_TERRAIN_FRONTIER     BATTLE_ENVIRONMENT_FRONTIER
#define BATTLE_TERRAIN_GYM          BATTLE_ENVIRONMENT_GYM
#define BATTLE_TERRAIN_LEADER       BATTLE_ENVIRONMENT_LEADER
#define BATTLE_TERRAIN_MAGMA        BATTLE_ENVIRONMENT_MAGMA
#define BATTLE_TERRAIN_AQUA         BATTLE_ENVIRONMENT_AQUA
#define BATTLE_TERRAIN_SIDNEY       BATTLE_ENVIRONMENT_SIDNEY
#define BATTLE_TERRAIN_PHOEBE       BATTLE_ENVIRONMENT_PHOEBE
#define BATTLE_TERRAIN_GLACIA       BATTLE_ENVIRONMENT_GLACIA
#define BATTLE_TERRAIN_DRAKE        BATTLE_ENVIRONMENT_DRAKE
#define BATTLE_TERRAIN_CHAMPION     BATTLE_ENVIRONMENT_CHAMPION
#define BATTLE_TERRAIN_GROUDON      BATTLE_ENVIRONMENT_GROUDON
#define BATTLE_TERRAIN_KYOGRE       BATTLE_ENVIRONMENT_KYOGRE
#define BATTLE_TERRAIN_RAYQUAZA     BATTLE_ENVIRONMENT_RAYQUAZA
